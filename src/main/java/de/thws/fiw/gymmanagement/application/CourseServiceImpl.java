...
public class CourseServiceImpl extends CourseServiceGrpc.CourseServiceImplBase {
    ...
    public void createCourse(CreateCourseRequest request, StreamObserver<GetCourseResponse> responseObserver) {
        System.out.println("[CourseService] createCourse called with name: " + request.getName() +
                ", capacity: " + request.getCapacity() + ", trainerId: " + request.getTrainerId());
        try {
            System.out.println("[CourseService] Invoking business logic for createCourse");
            ...
            System.out.println("[CourseService] createCourse succeeded: created course with id " + response.getCourseId());
        } catch (Exception e) {
    ...
    public void updateCourse(UpdateCourseRequest request, StreamObserver<GetCourseResponse> responseObserver) {
        System.out.println("[CourseService] updateCourse called for courseId: " + request.getCourseId() +
                " with new name: " + request.getName() + ", capacity: " + request.getCapacity() +
                ", trainerId: " + request.getTrainerId());
        try {
            System.out.println("[CourseService] Invoking business logic for updateCourse");
            ...
            responseObserver.onNext(response);
            responseObserver.onCompleted();
            System.out.println("[CourseService] updateCourse succeeded for courseId: " + response.getCourseId());
        } catch (Exception e) {
    ...
    public void getCourse(GetCourseRequest request, StreamObserver<GetCourseResponse> responseObserver) {
        System.out.println("[CourseService] getCourse called for courseId: " + request.getCourseId());
        try {
            Course course = courseService.getCourse(request.getCourseId());
            if (course == null) {
                System.err.println("[CourseService] getCourse: Course with id " + request.getCourseId() + " not found");
            ...
            responseObserver.onNext(response);
            responseObserver.onCompleted();
            System.out.println("[CourseService] getCourse succeeded for courseId: " + response.getCourseId());
        } catch (Exception e) {
    ...
    public void getCourseByName(GetCourseByNameRequest request, StreamObserver<GetAllCoursesResponse> responseObserver) {
        System.out.println("[CourseService] getCourseByName called with name: " + request.getName() +
                ", pagesize: " + request.getPagesize() + ", index: " + request.getIndex());
        try {
            System.out.println("[CourseService] Invoking business logic for getCourseByName");
            ...
            responseObserver.onCompleted();
            System.out.println("[CourseService] getCourseByName succeeded: returned " + courses.size() + " courses");
        } catch (Exception e) {
    ...
    public void getCourseByTrainer(GetCourseByTrainerRequest request, StreamObserver<GetAllCoursesResponse> responseObserver) {
        System.out.println("[CourseService] getCourseByTrainer called for trainerId: " + request.getTrainerId() +
                ", pagesize: " + request.getPagesize() + ", index: " + request.getIndex());
        try {
            System.out.println("[CourseService] Invoking business logic for getCourseByTrainer");
            ...
            responseObserver.onNext(builder.build());
            responseObserver.onCompleted();
            System.out.println("[CourseService] getCourseByTrainer succeeded: returned " + courses.size() + " courses");
        } catch (Exception e) {
    ...
    public void getAllCourses(GetAllCoursesRequest request, StreamObserver<GetAllCoursesResponse> responseObserver) {
        System.out.println("[CourseService] getAllCourses called with pagesize: " + request.getPagesize() +
                ", index: " + request.getIndex());
        try {
            System.out.println("[CourseService] Invoking business logic for getAllCourses");
            ...
            responseObserver.onNext(builder.build());
            responseObserver.onCompleted();
            System.out.println("[CourseService] getAllCourses succeeded: returned " + courses.size() + " courses");
        } catch (Exception e) {
    ...
    public void deleteCourse(DeleteCourseRequest request, StreamObserver<com.google.protobuf.Empty> responseObserver) {
        System.out.println("[CourseService] deleteCourse called for courseId: " + request.getCourseId());
        try {
            System.out.println("[CourseService] Invoking business logic for deleteCourse");
            courseService.deleteCourse(request.getCourseId());
            responseObserver.onNext(com.google.protobuf.Empty.getDefaultInstance());
            responseObserver.onCompleted();
            System.out.println("[CourseService] deleteCourse succeeded for courseId: " + request.getCourseId());
        } catch (Exception e) {
